...
import { getEditGuide } from "@/modules/content/application";
import { EditGuide } from "@/modules/content/presentation/edit-guide";
...
export default async function EditGuidePage({
  ...
  let result;
  try {
    result = await getEditGuide({ workspaceId: workspace.id, contentId });
  } catch (error) {
    if (
  ...
  return <EditGuide editGuide={result} locale={locale} workspaceId={workspace.id} />;
}
